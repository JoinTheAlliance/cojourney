...
export default {
  name: "INTRODUCE",
  description: "Introduce the user to someone from the rolodex who they might like to chat with. Only use this if the user is expressing interest in meeting someone new. If the user has not expressed interest, DO NOT USE THIS ACTION.",
  handler,
  examples: [
    JSON.stringify({ userA: "xxgokuinmexicancartel69", userB: "nahidwinlobotomykaisen1" }),
  ],
};
