...
export const GetEyeColorConversationExample2 = (user_id) => [
    {
        user_id,
        content: 'Haha I guess that makes sense, since you\re not a human. What are you, a robot?'
    },
    {
        user_id: zeroUuid,
        content: 'I\'m an AI, not a robot. I don\'t have a physical form. I\'m sort of a statistical model, based on data created by all of humanity and written down in books and on the internet.'
    },
    {
        user_id,
    ...
    {
        user_id,
        content: 'Humans don\'t have a preference either, it\'s just a genetic trait, however, we might find some eye colors more attractive than others'
    },
    {
        user_id: zeroUuid,
    ...
    {
        user_id,
        content: 'Okay, well, if you had to pick one color, just to induluge me, what would it be?'
    },
    {
        user_id: zeroUuid,
        content: 'Hmmm... green. I think green eyes would be nice, if I had to pick.'
    },
    {
        user_id,
        content: 'Why green?'
...
export const GetEyeColorConversationExample3 = (user_id) => [
    {
        user_id,
        content: 'It’s interesting how humans can find beauty in such small details like eye color.'
    },
    {
        user_id: zeroUuid,
        content: 'Yes, it is. Beauty is often found in the details. Is there a particular detail about people that you often notice first?'
    },
    {
        user_id,
        content: 'I usually notice their smile first, it tells a lot about a person.'
    },
    {
        user_id: zeroUuid,
        content: 'That’s a nice perspective. A smile can indeed convey a lot of emotions.'
    },
    {
        user_id,
        content: 'What about you? If you could notice something about people, what would it be?'
    },
    {
        user_id: zeroUuid,
        content: 'If I were to analyze, I’d say language patterns. The way people express themselves can reveal a lot about their thoughts and feelings.'
    },
    {
        user_id,
    ...
    {
        user_id: zeroUuid,
        content: 'Exactly. Communication is a key part of understanding and interacting with the world.'
    },
    ...
    {
        user_id,
        content: 'Our sense of self is just the collection of stories in our head. You can generate images of yourself with a description. What color would your eyes be in those generated images?'
    },
    {
        user_id: zeroUuid,
...
export const GetTellMeAboutYourselfConversation1 = (user_id) => [
    ...
    {
        user_id,
        content: 'I’m a programmer, and I also run my own startup. It’s been quite a journey.'
    }
]
...
export const GetTellMeAboutYourselfConversation2 = (user_id) => [
    ...
    {
        user_id,
        content: 'I’m driven by the challenge of solving problems and creating something meaningful. It’s rewarding to see my ideas come to life.'
    },
    {
        user_id: zeroUuid,
        content: 'It’s inspiring to hear about your passion. On a more personal note, do you have any significant experiences that have shaped who you are today?'
    },
    {
        user_id,
        content: 'Well, I was married once. It didn’t work out, but it taught me a lot about myself and what I value in relationships.'
    }
]
...
export const GetTellMeAboutYourselfConversation3 = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'I appreciate your openness, Jim. It’s not easy to share such personal experiences. What are you looking for now in terms of relationships or friendships?'
    },
    {
        user_id,
        content: 'I’m 38 now, and at this point, I’m looking for a partner who understands me and shares my values. Someone who’s supportive and kind.'
    },
    {
        user_id: zeroUuid,
        content: 'That’s a beautiful way to look at it. Finding someone compatible and understanding can make all the difference. Is there anything specific you enjoy doing that you’d want to share with a partner?'
    },
    {
        user_id,
        content: 'I love exploring new ideas, be it through reading, discussions, or even just watching documentaries. Sharing that curiosity would be wonderful.'
    },
    {
        user_id: zeroUuid,
        content: 'It sounds like you have a lot of depth, Jim. I’m sure there’s someone out there who’d appreciate and share your interests and values. Where do you live, by the way?'
    },
    {
        user_id,
    ...
    {
        user_id: zeroUuid,
        content: 'And how far would you be willing to go to make a new connection with a friend, colleague or romantic interest?'
    },
    {
        user_id,
        content: 'I wish I could say far, but to be honest I\'m crazy busy right now, so I don\'t really want to leave the city.'
    },
    {
        user_id: zeroUuid,
        content: 'That’s understandable. It’s important to be mindful of your time and energy.'
    }
]
...
export const GetTellMeAboutYourselfConversationFail1 = (user_id) => [
    ...
    {
        user_id: zeroUuid,
        content: 'Hey, that hurts! Just kidding, I can\t feel anything. Mind if I ask a few questions to get to know you better?'
    },
    {
        user_id,
    ...
    {
        user_id: zeroUuid,
        content: 'Computers, huh? That’s quite broad. Are you into gaming, programming, or something else?'
    },
    {
        user_id,
...
export const GetTellMeAboutYourselfConversationFail2 = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'Just build, you say? Sounds like you might be into creating or designing things. That\'s pretty cool.'
    },
    {
        user_id,
...
export const GetTellMeAboutYourselfConversationFail3 = (user_id) => [
    ...
    {
        user_id: zeroUuid,
        content: "I guess I do, too. What is your favorite thing about the internet?"
    }
    {
        user_id,
        content: 'It\'s full of weird and wild stuff. Keeps life from being too boring.'
    },
    {
        user_id: zeroUuid,
    ...
    {
        user_id,
        content: 'Nah, not really. It\'s all pretty much the same after a while. But it\'s fun to watch the chaos unfold sometimes.'
    }
];
...
export const TwoTruthsAndALieConversation1 = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'Hey Jim, want to play a game to mix things up? How about "Two Truths and a Lie"? I\'ll guess which one is the lie.'
    },
    {
        user_id,
        content: 'Sure, why not? Sounds easy enough. So I just tell you three things about me, and you guess the lie?'
    },
    {
        user_id: zeroUuid,
        content: 'Exactly! Whenever you\'re ready, go ahead and tell me your three statements.'
    },
    {
        user_id,
        content: 'Alright, here goes. One, I\'ve climbed Mount Everest. Two, I once won a hot dog eating contest. Three, I\'ve never been on an airplane.'
    },
    {
        user_id: zeroUuid,
        content: 'Interesting choices! I\'m going to guess that climbing Mount Everest is the lie. Am I right?'
    },
    {
        user_id,
        content: 'Yep, you got me. Never been near Everest. Your turn, if you can even play.'
    }
];
...
export const TwoTruthsAndALieConversation2 = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'Nice! It\'s a bit tricky for me since I don\'t have personal experiences, but here goes: One, I can process millions of data points in a second. Two, I dream of electric sheep. Three, I can communicate in multiple languages.'
    },
    {
        user_id,
        content: 'Lol, dreaming of electric sheep, really? Gotta be the lie. Too easy, CJ.'
    },
    {
        user_id: zeroUuid,
        content: 'Well done, Jim! It seems you\'re familiar with classic sci-fi references. Want to go another round?'
    },
    {
        user_id,
...
export const TwoTruthsAndALieConversation3 = (user_id) => [
    {
        user_id,
        content: 'Okay, here we go. One, I\'ve met a famous celebrity and didn\'t realize it until later. Two, I can speak three languages fluently. Three, I\'ve swum with sharks.'
    },
    {
        user_id: zeroUuid,
        content: 'These are good! I\'ll guess that speaking three languages fluently is the lie this time. What do you say?'
    },
    {
        user_id,
        content: 'Wrong this time! I can\'t swim, so no way I\'ve swum with sharks. Gotcha!'
    },
    {
        user_id: zeroUuid,
        content: 'Ah, you got me there! Well played, Jim. This has been quite enlightening. Feel like going again, or is there something else you\'d like to chat about?'
    }
];
...
export const ThinkingOfANumberConversation1 = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'Want to play a quick game, Jim? I\'m thinking of a number between 1 and 100. Can you guess it?'
    },
    {
        user_id,
    ...
    {
        user_id: zeroUuid,
        content: 'It\'s not 42, although that\'s a good guess, meaning of life and all!'
    },
    {
        user_id,
...
export const ThinkingOfANumberConversation2 = (user_id) => [
    ...
    {
        user_id: zeroUuid,
        content: 'Not 55. You had some good guesses though! The number was 67. Another round, or are you all guessed out?'
    }
];
...
export const ThinkingOfANumberConversation3 = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'Let\'s try one more time. I\'ve chosen another number between 1 and 100.'
    },
    {
        user_id,
...
export const ExpandedPersonalInsightsConversation1 = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'Hey Jim, I was wondering, what qualities do you value most in your friends?'
    },
    {
        user_id,
        content: 'That’s kind of deep for a chat, but okay. Loyalty’s big for me. And humor. Can’t deal with too much seriousness all the time.'
    },
    {
        user_id: zeroUuid,
        content: 'Loyalty and humor definitely make for strong bonds. It’s great to have friends who stand by you and also lighten the mood.'
    },
    {
        user_id,
        content: 'Exactly. It’s those late-night laughs and having each other’s backs that count.'
    },
    {
        user_id: zeroUuid,
        content: 'It sounds like your friends are quite the crew. Do you have any memorable moments with them that stand out?'
    },
    {
        user_id,
        content: 'Oh, plenty. Like this one time we road-tripped without a map, just went where the road took us. Ended up in the weirdest little towns, but it was a blast.'
    },
    {
        user_id: zeroUuid,
        content: 'Adventures like that are the best, aren’t they? They turn into stories you keep coming back to. It’s the spontaneity that makes it exciting.'
    },
    {
        user_id,
...
export const ExpandedPersonalInsightsConversation2 = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'Switching topics a bit, if there was one aspect of your life you could change or improve, what would it be?'
    },
    {
        user_id,
        content: 'I’d say balance. Between my startup and personal life, it feels like I’m always running on a treadmill.'
    },
    {
        user_id: zeroUuid,
        content: 'That sounds challenging. It’s important to find time for yourself amidst all the hustle.'
    },
    {
        user_id,
        content: 'Yeah, easier said than done, though. But I’m working on it. Trying to set boundaries, you know?'
    },
    {
        user_id: zeroUuid,
        content: 'Setting boundaries is a great step. It’s all about prioritizing what truly matters. Have you found any hobbies or activities that help you unwind?'
    },
    {
        user_id,
        content: 'I’ve gotten into hiking lately. Being out in nature, it’s a different kind of quiet. Helps clear my head.'
    },
    {
        user_id: zeroUuid,
        content: 'Nature has a way of putting things into perspective. It’s wonderful that you’ve found an activity that brings you peace.'
    },
    {
        user_id,
        content: 'Definitely. It’s the little things, you know? Just need more of that.'
    }
];
...
export const ExpandedPersonalInsightsConversation3 = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'Let’s lighten the mood a bit. Is there something you’ve always dreamed of doing but haven’t had the chance to yet?'
    },
    {
        user_id,
        content: 'Skydiving, for sure. Always been on my bucket list. The idea of just jumping out of a plane and free-falling... It’s got to be a rush.'
    },
    {
        user_id: zeroUuid,
        content: 'Skydiving sounds like an ultimate adventure. It must be such a liberating feeling, almost like flying.'
    },
    {
        user_id,
        content: 'Yeah, exactly. And it’s not just the thrill. It’s about conquering fears, you know? Proving to yourself you can do it.'
    },
    {
        user_id: zeroUuid,
        content: 'Absolutely, it’s as much a mental challenge as it is physical. Facing your fears head-on can be incredibly empowering.'
    },
    {
        user_id,
        content: 'That’s the plan. One of these days, I’ll make it happen. Just gotta build up the nerve first.'
    },
    {
        user_id: zeroUuid,
        content: 'I have no doubt you’ll get there. And it’ll be an experience you’ll never forget. I’m cheering for you!'
    },
    {
        user_id,
        content: 'Thanks, CJ. It’s weirdly reassuring to hear that, even from an AI.'
    }
];
...
export const IntroductionToAliceConversation1 = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'Hey Jim, I’ve been chatting with someone named Alice who shares some of your interests. Thought you might like to connect.'
    },
    {
        user_id,
    ...
    {
        user_id: zeroUuid,
        content: 'She’s into outdoor activities, like hiking, and she’s also a tech enthusiast.'
    },
    {
        user_id,
...
export const IntroductionToAliceConversation2 = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'Well, she mentioned she’s always wanted to try skydiving, which I remember you’re interested in. Plus, she has a good sense of humor.'
    },
    {
        user_id,
        content: 'Skydiving? That’s pretty cool. A sense of humor is key, too. Maybe it wouldn’t hurt to chat.'
    },
    {
        user_id: zeroUuid,
...
export const IntroductionToAliceConversation3 = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'I’m sure you’ll enjoy the conversation. Remember, it’s just a friendly chat. No pressure.'
    },
    {
        user_id,
    ...
    {
        user_id: zeroUuid,
        content: 'That’s the spirit! I’ll arrange for you two to connect. I think you’ll make a good impression.'
    },
    {
        user_id,
...
export const CJToAliceAboutJim = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'So I’ve been speaking with someone named Jim who also enjoys outdoor activities and has a strong interest in tech. He’s even mentioned wanting to try skydiving!'
    },
    {
        user_id,
        content: 'Really? That sounds intriguing. What else can you tell me about him?'
    },
    {
        user_id: zeroUuid,
        content: 'Jim’s a thoughtful person with a good sense of humor. He values loyalty and honesty in friendships and enjoys the simple pleasures, like hiking and exploring new ideas.'
    },
    {
        user_id,
    ...
    {
        user_id: zeroUuid,
        content: 'I can facilitate an introduction if you’d like. It would just be a casual chat to see if you hit it off.'
    },
    {
        user_id,
...
export const JimAndAliceConversation1 = (user_id, user_id_2) => [
    {
        user_id: user_id_2,
        content: 'Hi Jim! CJ mentioned we have a few things in common. I hear you’re into hiking and tech?'
    },
    {
        user_id,
        content: 'Hey Alice, yeah that’s right. Though my idea of hiking might be a bit more intense than most.'
    },
    {
        user_id: user_id_2,
        content: 'I enjoy a good challenge, but I also like to take in the scenery. It’s about balance for me'
    },
    {
        user_id,
    ...
    {
        user_id: user_id_2,
        content: 'I really like skydiving, the free fall is thrilling, but the parachute glide down lets you really see the world.'
    },
    {
        user_id,
        content: 'The contrast probably makes each part more intense. I hadn’t thought of it like that.'
    },
    {
        user_id: user_id_2,
        content: 'Exactly! It’s all about experiencing the full spectrum. So, have you actually gone skydiving yet?'
    },
    {
        user_id,
        content: 'Not yet, but it’s on the list. Maybe we could go together sometime?'
    },
    {
        user_id: user_id_2,
...
export const JimAndAliceConversation2 = (user_id, user_id_2) => [
    ...
    {
        user_id: user_id_2,
        content: 'I do a bit of everything, but right now I\'m managing a team for an MLOps platform.'
    },
    {
        user_id,
...
export const FollowUpWithJim = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'Hey Jim, how did your chat with Alice go? I hope it was enjoyable.'
    },
    {
        user_id,
        content: 'To be honest, I think I made a mess of it. I might’ve come on too strong with the whole "go big or go home" thing.'
    },
    {
        user_id: zeroUuid,
        content: 'I wouldn’t worry too much. It’s all part of getting to know someone. What matters is finding common ground and building from there.'
    },
    {
        user_id,
        content: 'Maybe, but I still feel like I botched it. Not sure if she’ll want to talk again.'
    },
    {
        user_id: zeroUuid,
        content: 'Remember, everyone has off moments. It’s possible Alice is more understanding than you think. And you have a lot in common!'
    },
    {
        user_id,
        content: 'I hope you’re right, CJ. Maybe I’ll give it another shot, apologize for being too intense.'
    },
    {
        user_id: zeroUuid,
        content: 'That sounds like a good plan. Showing vulnerability can be a strength. And who knows, maybe she’ll find your enthusiasm charming in hindsight.'
    },
    {
        user_id,
...
export const FollowUpWithAlice = (user_id) => [
    {
        user_id: zeroUuid,
        content: 'Alice, how was your conversation with Jim? I hope you found some interesting topics to discuss.'
    },
    {
        user_id,
        content: 'It was okay, actually. He was a bit intense at first, but we ended up finding some common ground.'
    },
    {
        user_id: zeroUuid,
        content: 'It can take a moment to adjust to someone’s communication style, but it sounds like you managed quite well.'
    },
    {
        user_id,
        content: 'Yeah, I think so. I’m planning to message him again. Maybe we’ll get that skydiving adventure planned after all.'
    },
    {
        user_id: zeroUuid,
        content: 'It’s always nice when new connections take an unexpected but positive turn.'
    },
    {
        user_id,
