...
const FriendsSideMenuScreen = (): JSX.Element => {
  ...
  const defaultFriends = friends.filter((friend) => friend.user_b === "00000000-0000-0000-0000-000000000000");
  const notDefaultFriends = friends.filter((friend) => friend.user_b !== "00000000-0000-0000-0000-000000000000");
  ...
  return (
    <>
      <FriendsList user={user} friends={defaultFriends} />
      <Accordion
        m={10}
        variant="separated"
