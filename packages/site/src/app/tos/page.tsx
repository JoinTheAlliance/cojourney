      ...
      <div className="container mx-auto p-4 px-[100px] text-black">
        ...
        <section className="mb-6">
          ...
          <p className="mb-4">
            ...
            ("User", "you") and Clio Dynamics, Inc. ("Cojourney", "Company",
            "we", "us"). They apply to the website available at https://cojourney.app (the
            "Website"), and the Cojourney mobile application (the "App"),
        ...
        <section className="mb-6">
          ...
          <p className="mb-4">
            Cojourney's liability is limited under these Terms. You may not
